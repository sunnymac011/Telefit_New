...
public class ExercisesAllListBean implements Parcelable {
    ...
    public ExercisesAllListBean() {
    }

    protected ExercisesAllListBean(Parcel in) {
        id = in.readString();
        catId = in.readString();
    ...
    public static final Creator<ExercisesAllListBean> CREATOR = new Creator<ExercisesAllListBean>() {
        @Override
        public ExercisesAllListBean createFromParcel(Parcel in) {
            return new ExercisesAllListBean(in);
        }

        @Override
        public ExercisesAllListBean[] newArray(int size) {
            return new ExercisesAllListBean[size];
        }
    };
